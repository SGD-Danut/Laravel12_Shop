...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">New Section</h1>
    <!-- Content Row -->
    <div class="row">
        <div class="col-xl-12 col-lg-11">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('create-new-section') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input name="description" value="{{ old('description') }}" type="text" class="form-control @error('description') is-invalid @enderror" id="inputDescription">
                          @error('description')
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="active" id="active1" value="1" {{ old('active') == true ? 'checked' : '' }} @if (is_null(old('active'))) checked @endif>
                                <label class="form-check-label" for="active1">
                                    Active
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="active" id="active2" value="0" {{ old('active' == false ? 'checked' : '') }}>
                        ...
                        <div class="form-group col-md-2">
                            <label>State</label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="promoted" id="promoted1" value="0" {{ old('promoted') == false ? 'checked' : '' }} @if (is_null(old('promoted'))) checked @endif>
                                <label class="form-check-label" for="promoted1">
                                    Standard
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="promoted" id="promoted2" value="1" {{ old('promoted') == true ? 'checked' : '' }}>
