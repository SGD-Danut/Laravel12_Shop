...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">New Brand</h1>
    <!-- Content Row -->
    <div class="row">
        <div class="col-xl-12 col-lg-11">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('create-new-brand') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <div class="mb-3 rounded mx-auto d-block" id="image-preview">
                            <img src="/admin/img/content/brands/brand.png" width="258" alt="Brand image">
                          </div>
