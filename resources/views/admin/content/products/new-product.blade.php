                      ...
                      <div class="form-row">
                        <div class="form-group col-md-4">
                          ...
                          <select name="section" class="custom-select">
                            <option value="" selected>Select product section</option>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input name="price" value="{{ old('price') }}" type="number" class="form-control @error('price') is-invalid @enderror" id="inputPrice">
                            @error('price')
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input name="discount" value="{{ old('discount', 0) }}" type="number" class="form-control @error('discount') is-invalid @enderror" id="inputDiscount">
                            @error('discount')
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input name="stock" value="{{ old('stock', 50) }}" type="number" class="form-control @error('stock') is-invalid @enderror" id="inputStock">
                            @error('stock')
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input name="position" value="{{ old('position', 10) }}" type="number" class="form-control @error('position') is-invalid @enderror" id="inputPosition">
                            @error('position')
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <div class="mb-3 rounded mx-auto d-block" id="image-preview">
                            <img src="/admin/img/content/products/product.png" width="258" alt="Product image">
                          </div>
